...
module.exports = {
    ...
    getPerson: function getPerson(options) {
        var opts = parseOptions(options);
        return makeRequest('people' + (opts.id ? '/' + opts.id : '/'));
    },
    getStarship: function getStarship(options) {
        var opts = parseOptions(options);
        return makeRequest('starship' + (opts.id ? '/' + opts.id : '/'));
    },
    getVehicle: function getVehicle(options) {
        var opts = parseOptions(options);
        return makeRequest('vehicles' + (opts.id ? '/' + opts.id : '/'));
    },
    getFilm: function getFilm(options) {
        var opts = parseOptions(options);
        return makeRequest('films' + (opts.id ? '/' + opts.id : '/'));
    },
    getSpecies: function getSpecies(options) {
        var opts = parseOptions(options);
